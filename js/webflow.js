 ...
 */ !(function (t) {
  ...
  function (t, e, n) {
    ...
    var i = r(n(27)),
      ...
      w = a.IX2VanillaUtils.reifyState;
    e.rawDataImported = function (t) {
      return { type: c, payload: (0, i.default)({}, w(t)) };
    };
  ...
  function (t, e, n) {
    ...
    window.tram = (function (t) {
      ...
      var f = (function (t, e, n) {
        ...
        C = function (t) {
          ...
          for (e = 0; e < w.length; e++)
            if ((n = w[e] + r) in R.style) return { dom: n, css: N[e] + t };
        },
        x = (e.support = {
      ...
      if (x.transition) {
        var L = x.timing.dom;
        if (((R.style[L] = l["ease-in-back"][0]), !R.style[L]))
      ...
      var P = (e.frame = (function () {
        ...
        j = f(function (e) {
          ...
          (e.init = function (e) {
            ...
            x.backface &&
              H.hideBackface &&
              z(this.el, x.backface.css, "hidden");
          }),
            y("add", i),
            y("start", o),
            y("wait", function (t) {
      ...
      i && n.dispatch((0, I.rawDataImported)(i)),
        u.active ||
          ...
          o &&
            ...
            -1 === (e = document.documentElement).className.indexOf(w) &&
              (e.className += " ".concat(w)),
  ...
  function (t, e, n) {
    n(120), n(122), n(124), n(314), n(315), (t.exports = n(316));
  },
  function (t, e, n) {
    "use strict";
    var r = n(12);
    ...
    t.exports = function (t, e, n, E, _, g) {
      ...
      if (!(n & l)) {
        var S = O && h.call(t, "__wrapped__"),
          R = b && h.call(e, "__wrapped__");
        if (S || R) {
          var w = S ? t.value() : t,
            N = R ? e.value() : e;
          return g || (g = new r()), _(w, N, n, E, g);
        }
      }
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n, r, T, b, A) {
      switch (n) {
        ...
        case _:
          var R = r & s;
          if ((S || (S = c), t.size != e.size && !R)) return !1;
          var w = A.get(t);
          if (w) return w == e;
          (r |= f), A.set(t, e);
  ...
  function (t, e, n) {
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }),
            ...
            return (function (t, e, n, r, i) {
              ...
              Ct(t, y.TRANSFORM_PREFIXED, i),
                ...
                ((s === J && void 0 !== d) ||
                  ...
                  a(t, y.TRANSFORM_STYLE_PREFIXED, N);
              var u, c, s, f, l, d;
            })(t, e, n, i, a);
          case q:
              ...
              switch (u) {
                case ot:
                  var s = r.config,
                    ...
                    E = n.heightValue;
                  void 0 !== h &&
                    (d === W && (d = "px"), Ct(t, D, o), a(t, D, h + d)),
                    void 0 !== E &&
                      (v === W && (v = "px"), Ct(t, P, o), a(t, P, E + v));
                  break;
                case it:
                  !(function (t, e, n, r) {
                    var i = (0, l.default)(
            ...
            return (function (t, e, n) {
              ...
              switch (e.actionTypeId) {
                case st:
                  ...
                  return void (i === C && y.IS_BROWSER_ENV
      ...
      (e.cleanupHTMLElement = function (t, e, n) {
        ...
        i(t, B) && Pt({ effect: xt, actionTypeId: o, elementApi: n })(t);
      }),
    ...
    function yt(t) {
      ...
      if (
        (C
          ? ((S = N.limitAffectedElements), (R = x), (w = u(N)))
          : (R = w = u({ id: g, selector: m, selectorGuids: T })),
        n && b)
      ) {
        var L = r && (w || !0 === b) ? [r] : c(x);
        if (w) {
    ...
    var r = n(2),
      ...
      O = function (t, e) {
        ...
        if (r && i) {
          ...
          if (b < 0) return t;
          var w = v(Math.min(Math.max(0, b / m), 1)),
            N = h(y, w, g),
            C = {},
            x = null;
          return (
            d.length &&
              (x = d.reduce(function (t, e) {
                var n = l[e],
                  r = parseFloat(i[e]) || 0,
        ...
        (0, o.default)(r, P, {
          ...
          handler: function (t) {
            ...
            return (
              ...
              (u !== h.EventBasedOn.ELEMENT || R || R !== a.elementHovered) &&
                ((A = f ? 1 - A : A),
                e.dispatch((0, _.parameterChanged)(S, A))),
              { elementHovered: R, clientX: v, clientY: g, pageX: I, pageY: T }
            );
          },
        }),
        (0, o.default)(r, W, {
        ...
        (0, o.default)(r, G, {
          ...
          handler: function (t) {
            ...
            var R = K(i, v),
              ...
              C = (y ? b : 0) / 100;
            (N = E ? N : 1 - N), (C = g ? C : 1 - C);
            var x = w.top + Math.min(w.height * N, l),
              L = w.top + w.height * C - x,
              D = Math.min(l + L, f),
              P = Math.min(Math.max(0, l - x), D) / D;
            return (
              P !== o.scrollPercent &&
                n.dispatch((0, _.parameterChanged)(R, P)),
              { scrollPercent: P }
            );
          },
        }),
  ...
  events: {
    ...
    "e-3": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "5f10bf0e436860ff4f23e51b|f57fc0f9-3173-8452-ca95-c609f4e8b93f",
      },
      config: {
        loop: false,
        playInReverse: false,
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5f10bf0e436860ff4f23e51b|f57fc0f9-3173-8452-ca95-c609f4e8b93f",
                },
                value: 0,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5f10bf0e436860ff4f23e51b|752e3c2d-d5d5-8564-4c09-d99e22afcc77",
                },
                value: 0,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5f10bf0e436860ff4f23e51b|4828ae4c-74f3-5ddc-768d-74183b960a76",
                },
                value: 0,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5f10bf0e436860ff4f23e51b|d6467c9b-e975-7560-3627-95c927299b14",
                },
                value: 0,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5f10bf0e436860ff4f23e51b|ab1fc678-7c40-e774-434c-93c530d2e0bb",
                },
                value: 0,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5f10bf0e436860ff4f23e51b|bd0f5b28-e097-2e01-b871-c9083e5f8ba6",
                },
                value: 0,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5f10bf0e436860ff4f23e51b|bbfc8fb2-6f6a-059c-793e-09911f4105ff",
                },
                value: 0,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5f10bf0e436860ff4f23e51b|6d3e520d-c11b-eba9-d87e-74f1f112c777",
                },
                value: 0,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5f10bf0e436860ff4f23e51b|2e63713e-9094-06c8-5dae-21664b5ee485",
                },
                value: 0,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5f10bf0e436860ff4f23e51b|3377a7c7-3f86-6a5c-5a19-f7c68bd66ca2",
                },
                value: 0,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  id:
                    "5f10bf0e436860ff4f23e51b|ad5e9802-abb2-94cf-5f9e-242f53f015d9",
                },
                value: 0,
                unit: "",
              },
